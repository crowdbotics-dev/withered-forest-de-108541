...
## Project Structure
    ...
    ├── withered_forest_de_108541  # Django project configurations
...
1. Clone this repo and `cd withered_forest_de_108541`
...
2. Clone this repo and `cd withered_forest_de_108541`
